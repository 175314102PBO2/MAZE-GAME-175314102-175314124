...
public class MAZE extends javax.swing.JFrame {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            peta.MLAKU(perintahText.getText());
            perintahText.setText("");
            isCompleted();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Baca Peta Dulu !", "Peringatan", 0);
        }
    ...
    private void exitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitMenuItemActionPerformed
        JOptionPane.showMessageDialog(null, " Thanks You -_- ");
        System.exit(0);
    ...
    private void isCompleted() {
        if (peta.isComplete()) {
            JOptionPane.showMessageDialog(null, " Congratulation Wayang wis Tekan ");
            selPanel.removeAll();
            System.exit(0);
        }
    }
